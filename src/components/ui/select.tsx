...
function SelectItem({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Item>) {
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // Deviates from the shadcn default (`cursor-default`, which imitates a native select): every control a visitor
        // can click in this app shows a pointer, and the model list is a long one people click through.
