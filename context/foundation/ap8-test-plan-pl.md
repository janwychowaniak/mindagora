...
| `lib/services/auth.service.ts`       | `extractBearerToken`              | brak nagłówka → `null`; `Basic …` → `null`; `Bearer` bez tokenu → `null`; `Bearer abc` → `abc`; `bearer abc` (małe litery) → `abc`; wiele spacji po `Bearer`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | tylko `new Request(url, { headers })`; moduł czyta env na poziomie modułu, ale nie używa go przy imporcie                                                                                                                                                                                              |
