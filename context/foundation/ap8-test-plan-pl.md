...
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `LogoutButton`      | sukces → `/login`; `401` (sesja już nieważna) → też `/login`, bez komunikatu; inny błąd → komunikat, zostaje na stronie; status 0 → komunikat sieciowy                                                                                                                                                                                                                                                                                                                                                                                             |
...
- **Formularze auth (`LoginForm`, `RegisterForm`), `ApiKeyForm`, `ParticipantList`,
  `ConversationListItem`, `ModelCombobox`** — mają gałęzie (np.
