...
| #7   | integration | smoke: SETNULL-1 (the delete succeeds) with the SETNULL-2 note recording that the deleted participant's message keeps a null author while the other reply keeps its alias (a logged observation, not an assertion), DCID-6 (CASCADE on conversation delete)                                                                                                                                                                                                                                                                                                                                                                 |
